...
function Assistent() {
  return (
    <Container className="mt-3" id="assistent">
      ...
      <Card className="m-4 p-4 shadow">
        ...
        <div className="servic-row row container mt-4 mx-1">
            ...
            <button style={{ border: "none" }}>
              <div className="servcover">
                <Link to="/Paedodontics">
                  ...
                  <h4>Paedodontics</h4>
                  <p>
                    Examination and treatment of all dental problems for
                    children
                  </p>
                </Link>
              </div>
              ...
              <div>
                <div className="servcover">
                  <Link to="/surgery">
                    ...
                    <h4>Surgery</h4>
                    <p>
                      Doing all dental surgical treatments to solve all problems
                    </p>
                  </Link>
                </div>
              </div>
              ...
              <div>
                <div className="servcover">
                  <Link to="/perodontics">
                    ...
                    <h4>Perodontics</h4>
                    <p>
                      Cleaning the gums from lime and dirt and treating the gums
                    </p>
                  </Link>
                </div>
              </div>
          ...
          <a
            href="#Prosthodontics"
            className="servic-col col-md-4 shadow pt-2 "
          >
            <button style={{ border: "none" }}>
              <div>
                <div className="servcover">
                  <Link to="/prosthodontics">
                    ...
                    <p>
                      Replacing missing teeth through dental implants and
                      dentures
                    </p>
                  </Link>
                </div>
